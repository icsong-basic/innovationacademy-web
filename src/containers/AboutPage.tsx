            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="only-pc col md-3 position-relative">
                        <LeftSideNavigator topStartElementId="section-wrap" className="about-navigator" pageId="about-page" id="about-navigator" nextPageButtonId="project-link">
                            <Link replace className={sectionIndex == 0 ? 'selected' : ''} to="#purpose">설립 목적</Link><br />
                            <Link replace className={sectionIndex == 1 ? 'selected' : ''} to="#summary">설립 개요</Link><br />
                            <Link replace className={sectionIndex == 2 ? 'selected' : ''} to="#history">주요 연혁</Link><br />
                            <Link replace className={sectionIndex == 3 ? 'selected' : ''} to="#bi">재단 BI</Link><br />
                            <Link replace className={sectionIndex == 4 ? 'selected' : ''} to="#organization">조직도</Link>
                        </LeftSideNavigator>
                    </div>
                    <div className="col md-9 sm-6" id="section-wrap">
                        <section className="purpose">
                            ...
                            <h3>이노베이션 아카데미는<br />
                                소프트웨어로 대한민국의 <br className="only-mobile" />미래를 준비합니다.</h3>
                            <p className="only-pc">
                                이노베이션 아카데미는 소프트웨어 인재 양성과 소프트웨어 산업 발전에 기여함을 목적으로 2019년에 설립된 비영리 재단입니다.<br />
                                우리는 혁신적인 소프트웨어 교육 프로그램인 42 SEOUL을 시작으로 누구나 소프트웨어 개발자에 도전할 수 있는 기회와 환경을 제공합니다.<br />
                                이노베이션 아카데미는 대한민국 모든 곳에서 미래를 위한 교육 혁신이 이뤄지길 바라며, 이를 위해 우리의 경험과 데이터를 바탕으로 교육 시스템의 새로운 모델을 제시하고자 합니다.<br />
                                <br />
                                소프트웨어 개발자들의 도전과 혁신이 만들어갈 변화와 미래.<br />
                            ...
                            <p className="only-mobile">
                                ...
                                우리는 혁신적인 소프트웨어 교육 프로그램인 42 SEOUL을 시작으로 누구나 소프트웨어 개발자에 도전할 수 있는 기회와 환경을 제공합니다.<br />
                                <br />
                                이노베이션 아카데미는 대한민국 모든 곳에서 미래를 위한 교육 혁신이 이뤄지길 바라며, 이를 위해 우리의 경험과 데이터를 바탕으로 교육 시스템의 새로운 모델을
                                제시하고자 합니다.<br />
                                <br />
                                소프트웨어 개발자들의 도전과 혁신이 만들어갈 변화와 미래.<br />
                                <br />
                        ...
                        <section className="summary">
                            ...
                            <table className="no-border-bottom">
                                <tbody>
                                    <tr>
                                        <td>법인명 : 재단법인 이노베이션아카데미<br />
                                            고유번호 : 757-82-00285
                                    </td>
                                        <td>설립년원일 : 2019. 08. 01.<br />
                                            대표 : 이민석
                                    </td>
                                    </tr>
                                </tbody>
                        ...
                        <section className="history">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <th>18년 8월</th>
                                        <td>‘혁신성장 관계장관회의’ 안건<br className="only-pc" />
                                            (‘혁신성장 전략 투자방향’) 상정<br />
                        ...
                        <section className="bi">
                            ...
                            <div className="bi-txt-container">
                                <p>
                                    이노베이션 아카데미는 창의성, 안정성, 확장성을 중요하게 생각합니다.<br />
                                    이노베이션 아카데미 BI는 이러한 생각을 담아 제작되었습니다.
                                </p>
                                <div className="button-container">
                                    <a download target="_blank" rel="noopener noreferrer" href="https://innovationacademy.s3.ap-northeast-2.amazonaws.com/bi/ai.zip"><button>AI 다운로드</button></a>
                                    <a download target="_blank" rel="noopener noreferrer" href="https://innovationacademy.s3.ap-northeast-2.amazonaws.com/bi/jpg.zip"><button>JPG 다운로드</button></a>
                                </div>
                            </div>
